...
To design the LED and 7-segment display implementation, 
modules etc.
...
## Conclusion
I have spent 24 hours on this lab so far (but some of the hours were trying to debug software issues with Lattice Radiant and QuestaSim).
